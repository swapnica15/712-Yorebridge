...
<div class="form_row">
<div class="column-one-half">
<div class="form-group"><label for="form_service">Service *<span id="sererror" class="msg-error"></span>
<select id="form_service" class="" name="service" oninvalid="this.setCustomValidity('Please select one of the Services listed below')" oninput="this.setCustomValidity('')">
<option selected="selected" value="">- Select a Service -</option> 
<option value="House Rooms">House Rooms</option>
<option value="Hot Tub Rooms">Hot Tub Rooms</option>
<option value="Restaurant">Restaurant</option>
<option value="Grand Siècle Tasting Room">Grand Siècle Tasting Room</option>
...
<div class="form_row">
<div class="form-group"><label for="form_message">Message *<span id="frm_msg" class="msg-error"></span>
<textarea id="form_message" class="form-control from-control-msg qc_msg" name="message" required="true" rows="4" pattern="/^[a-zA-Z0-9 \(\)\n]*$/" data-error="Please,leave us a message."></textarea></label></div>
</div>
